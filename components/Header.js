        ...
        <header>
            <nav className="container flex flex-sb">
                <div className="logo flex gap-2">
                    <Link href='/'><img style={{ width: '150px' }} src={`/img/${darkMode ? "white" : "logo"}.png`} alt="" /></Link>
                ...
                <div className="navlist flex gap-2">
                    <ul className="flex gap-2">
                        ...
                        <li><Link href="/app"
                            className={activeLink === '/app' ? 'active' : ''}
                            onClick={() => handleLinkClick('/app')}>APP</Link></li>
                        <li><Link href="/shop"
                        ...
                        <li><Link href="/about"
                            ...
                            onClick={() => handleLinkClick('/about')}>About</Link></li>
                    </ul>
                ...
                <div className={mobile ? 'mobilenavlist active' : 'mobilenavlist'}>
                    ...
                    <ul style={{marginTop: '-0px'}} className="flex gap-1 flex-col flex-left mt-3" onClick={handleMobileClose}>
                        <li><Link href="/"
                            className={activeLink === '/' ? 'active' : ''}
                            onClick={() => handleLinkClick('/')}>Home</Link></li>
                        <li><Link href="/blogs"
                        ...
                        <li><Link href="/about"
                            className={activeLink === '/about' ? 'active' : ''}
                            onClick={() => handleLinkClick('/about')}>About</Link></li>
                            <p style={{position:'fixed', bottom:'25px'}}>Copyright &copy; 2025 | Rakshith</p>
                    </ul>
