...
const BlogPage = () => {
    ...
    console.log(formattedDate); // Outputs something like "20 Jan 2025 14:11 pm" if createdAtDate is valid
                        ...
                        <div className="blogslugpagecont">
                            ...
                            <div className="rightsitedetails">
                                ...
                                <div className="rightslugcategory">
                                    <h2>CATEGORIES</h2>
                                    <ul>
                                        <Link href='/blogs/category/User Interface'><li>User Interface<span>({allwork.filter(ab => ab.blogcategory[0] === "User Interface").length})</span></li></Link>
                                        <Link href='/blogs/category/User Experience'><li>User Experience<span>({allwork.filter(ab => ab.blogcategory[0] === "User Experience").length})</span></li></Link>
                                        <Link href='/blogs/category/Figma'><li>Figma<span>({allwork.filter(ab => ab.blogcategory[0] === "Figma").length})</span></li></Link>
                                        <Link href='/blogs/category/Gen AI'><li>Gen AI<span>({allwork.filter(ab => ab.blogcategory[0] === "Gen AI").length})</span></li></Link>
                                        <Link href='/blogs/category/Prompt Engineering'><li>Prompt Engineering<span>({allwork.filter(ab => ab.blogcategory[0] === "Prompt Engineering").length})</span></li></Link>
                                        <Link href='/blogs/category/HTML5'><li>HTML5<span>({allwork.filter(ab => ab.blogcategory[0] === "HTML5").length})</span></li></Link>
                                        <Link href='/blogs/category/CSS3'><li>CSS3<span>({allwork.filter(ab => ab.blogcategory[0] === "CSS3").length})</span></li></Link>
                                        <Link href='/blogs/category/Java Script'><li>Java Script<span>({allwork.filter(ab => ab.blogcategory[0] === "Java Script").length})</span></li></Link>
                                        <Link href='/blogs/category/Aptitude'><li>Aptitude<span>({allwork.filter(ab => ab.blogcategory[0] === "Aptitude").length})</span></li></Link>
                                        <Link href='/blogs/category/Soft Skills'><li>Soft Skills<span>({allwork.filter(ab => ab.blogcategory[0] === "Soft Skills").length})</span></li></Link>
                                        <Link href='/blogs/category/Resume Builder'><li>Resume Builder<span>({allwork.filter(ab => ab.blogcategory[0] === "Resume Builder").length})</span></li></Link>
                                        <Link href='/blogs/category/Interview'><li>Interview<span>({allwork.filter(ab => ab.blogcategory[0] === "Interview").length})</span></li></Link>
                                        <Link href='/blogs/category/Job Hunt'><li>Job Hunt<span>({allwork.filter(ab => ab.blogcategory[0] === "Job Hunt").length})</span></li></Link>
                                        <Link href='/blogs/category/AI Tools'><li>AI Tools<span>({allwork.filter(ab => ab.blogcategory[0] === "AI Tools").length})</span></li></Link>
                                        <Link href='/blogs/category/Others'><li>Others<span>({allwork.filter(ab => ab.blogcategory[0] === "Others").length})</span></li></Link>
                                    </ul>
                                </div>
