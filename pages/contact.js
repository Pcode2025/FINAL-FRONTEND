            ...
            <div className="container">
                <div className="contactformp">
                    <div className="leftcontp">
                        ...
                        <p>Looking to grow your business with professional websites, AI automation, digital marketing, or e-commerce solutions? We’ve got you covered!</p>
                        <p> Need technical support, hosting, or branding assistance? Let’s make it happen.</p>
                        <p> Use the form on this page or reach out to us directly.</p>
                        <p> We value your questions and feedback – and we’re always ready to help your business succeed!</p>
                        <div className="leftsociinfo" >
                            <ul>
                                <li><FaPhoneVolume /> <span>Phone: <a style={{fontSize: '1.1rem'}} href="tel:+919353241308" rel="nofollow" target="_blank">+91-9353241308</a></span></li>
                                <li><MdAttachEmail /> <span>Email: <a style={{fontSize: '1.1rem'}} href="/" rel="nofollow" target="_blank">support@mydesignnexus.in</a></span></li>
                                <li><GrLinkedin /> <span>Linkedin: <a style={{fontSize: '1.1rem'}} href="https://www.linkedin.com/in/rakshithgowdaofficial?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" rel="nofollow" target="_blank">Rakshith Gowda</a></span></li>
                                <li><AiFillInstagram /> <span>Twitter: <a style={{fontSize: '1.1rem'}} href="https://www.instagram.com/my.designnexus?igsh=Z2d5N2Qza3IzaWx1" rel="nofollow" target="_blank">@my.designnexus</a></span></li>
                            </ul>
                        </div>
                    </div>
                    <div className="rightcontp">
                        <form onSubmit={createProduct}>
                            ...
                            <div className="rightcontredio">
                                {['Less than $120', '$120 - $200', '$200 - $600', 'More than $600'].map((priceRange) => (
                            ...
                            <div className="rightcontpera">
                                <textarea required value={description} onChange={ev => setDescription(ev.target.value)} name="description" rows="4" id="" placeholder="Project description"></textarea>
                            </div>
                            <hr /><br /><br />
                            <label style={{marginLeft: '20px'}} className="cyberpunk-checkbox-label">
                                <input required
                                    type="checkbox"
                                    className="cyberpunk-checkbox"
                                />
                                <p><a href="/termsandconditions"><u><b>I Accept T&C</b></u></a>
                                </p>
                            </label>
